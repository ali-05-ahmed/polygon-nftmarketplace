...
export default function CreateItem() {
  ...
  const [endingUnix, setEndingUnix] = useState();
  ...
  async function createMarket() {
    ...
    if (!name || !description || !price || !fileUrl) return setError("Kindly provide the required fields");
...
try {
      ...
      transaction = await contract.createMarketItem(nftaddress, tokenId, price,tripType,endingUnix, {
        value: listingPrice,
      });
